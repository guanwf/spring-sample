...
public class CodeGenerator {
    ...
    // 数据库 URL
    private static final String URL = "jdbc:mysql://127.0.0.1:3306/demodb?useUnicode=true&characterEncoding=UTF-8&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
    // 数据库驱动
    ...
    // @author 值
    private static final String AUTHOR = "Guanwf";
    // 包的基础路径
    private static final String BASE_PACKAGE_URL = "com.github.spring.sqldemo";
    // xml文件路径
    private static final String XML_PACKAGE_URL = "/src/main/resources/mapper/customer";
    // xml 文件模板
    ...
    public static void main(String[] args) {
        ...
        packageConfig.setModuleName("share");
...
//        templateConfig.setXml(XML_MAPPER_TEMPLATE_PATH);
        ...
        strategy.setSuperEntityColumns("id","tid","creater","createtime","modifyer","modifytime");
        strategy.setControllerMappingHyphenStyle(true);
        strategy.setTablePrefix(packageConfig.getModuleName() + "_");
        strategy.setSuperEntityClass("com.github.obee.base.entity.SingleEntity");
        strategy.setSuperServiceClass("com.github.obee.base.sheetpage.BaomidouService");
        strategy.setSuperServiceImplClass("com.github.obee.sheetpage.service.BaomidouServiceImpl");
